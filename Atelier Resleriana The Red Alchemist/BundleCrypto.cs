//stolen from https://github.com/LukeFZ/AtelierTool/blob/6db749e4070480dee181c3ce7b4c37d33185639d/AtelierTool/BundleCrypto.cs
...
{
    public static Stream DecryptBundle(byte[] bundleData, string keyMaterial)
    {
        var bundleSpan = bundleData.AsSpan();

        var encBundle = bundleSpan[0x1A..];
