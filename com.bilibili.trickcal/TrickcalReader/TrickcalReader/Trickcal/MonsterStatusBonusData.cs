...
[MessagePackObject]
public class MonsterStatusBonusData : TableItem<TableData> {
    [Key(0)]
    ...
    [Key(22)]
    public int DamageReduceDefenseBravo { get; set; }
    [Key(23)]
    public int CriticalRateReduceDefenseBravo { get; set; }
    [Key(24)]
    public int CriticalMultReduceDefenseBravo { get; set; }
}
